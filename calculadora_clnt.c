...
result *
suma_1(double val1, double val2,  CLIENT *clnt)
{
	suma_1_argument arg;
...
result *
restar_1(double val1, double val2,  CLIENT *clnt)
{
...
result *
multiplica_1(double val1, double val2,  CLIENT *clnt)
{
...
result *
divide_1(double val1, double val2,  CLIENT *clnt)
{
